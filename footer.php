...
<footer class="footer-section text-center">
    <div class="container py-5 bg">
        ...
        <h5 class="text-start mb-3"><?php echo get_theme_mod('footer_bold_subtitle'); ?><span><?php echo get_theme_mod('footer_subtitle'); ?></span><?php echo get_theme_mod('footer_subtitle_sign'); ?></h5>
