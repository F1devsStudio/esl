...
if( class_exists( 'Kirki' ) ) {
    function f1devsesl_colors_section( $wp_customize ) {
        $wp_customize->get_control( 'background_color' )->label = esc_html__( 'Body Background Color', 'f1devs-esl' );
        $wp_customize->get_section( 'colors' )->title = esc_html__( 'Theme Colors', 'f1devs-esl' );
    }
    add_action( 'customize_register', 'f1devsesl_colors_section' );
}

F1devsesl_Kirki::add_field( 'f1devsesl_theme', array(
	'settings' => 'styling_header_bg_color',
	'label'    => esc_html__( 'Header Background Color', 'f1devs-esl' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#343a40',
    'output'   => array(
...
F1devsesl_Kirki::add_field( 'f1devsesl_theme', array(
	...
	'section'  => 'colors',
	'type'     => 'color',
    'label' => esc_html__( 'Links & Buttons Color', 'f1devs-esl' ),
    'default'  => '#007bff',
    'output'   => array(
        array(
...
F1devsesl_Kirki::add_field( 'f1devsesl_theme', array(
	...
	'label'    => esc_html__( 'Links & Buttons Hover Color', 'f1devs-esl' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#0069d9',
    'output'   => array(
...
F1devsesl_Kirki::add_field( 'f1devsesl_theme', array(
	...
	'label'    => esc_html__( 'Footer Background Color', 'f1devs-esl' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#ffffff',
    'output'   => array(
...
F1devsesl_Kirki::add_field( 'f1devsesl_theme', array(
	...
	'label'    => esc_html__( 'Footer Text Color', 'f1devs-esl' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#6c757d',
    'output'   => array(
...
F1devsesl_Kirki::add_field( 'f1devsesl_theme', array(
	...
	'label'    => esc_html__( 'Footer Link Color', 'f1devs-esl' ),
	'section'  => 'colors',
	'type'     => 'color',
    'default'  => '#007bff',
    'output'   => array(
